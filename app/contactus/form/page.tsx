...
export default function ContactUsForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (response.ok) {
      ...
      router.push("/contactus/list"); // Redirect to list page after submission
    } else {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-md shadow-md">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 font-semibold mb-2" htmlFor="contact">Contact Information</label>
          <input
            type="text"
            id="contact"
            name="contact"
